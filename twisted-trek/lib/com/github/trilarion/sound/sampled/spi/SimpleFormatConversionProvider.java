...
public abstract class SimpleFormatConversionProvider extends TFormatConversionProvider {
     ...
     * @param targetFormats
     */
    protected SimpleFormatConversionProvider(final Collection<AudioFormat> sourceFormats_in,
	    final Collection<AudioFormat> targetFormats_in) {
	Collection<AudioFormat> sourceFormats = sourceFormats_in;
	Collection<AudioFormat> targetFormats = targetFormats_in;
