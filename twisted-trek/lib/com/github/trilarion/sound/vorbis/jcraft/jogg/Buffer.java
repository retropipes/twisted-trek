...
public class Buffer {
     ...
     * @param bytes
     */
    public void read(final byte[] s, final int bytes_in) {
	int bytes = bytes_in;
	int i = 0;
	while (bytes-- != 0) {
     ...
     * @param bits
     */
    public void write(final int value_in, final int bits_in) {
	int bits = bits_in;
	int value = value_in;
     ...
     * @return
     */
    public int look(final int bits_in) {
	int bits = bits_in;
	int ret;
     ...
     * @param bits
     */
    public void adv(final int bits_in) {
	int bits = bits_in;
	bits += this.endbit;
	this.ptr += bits / 8;
	this.endbyte += bits / 8;
     ...
     * @return
     */
    public int read(final int bits_in) {
	int bits = bits_in;
	int ret;
	final int m = Buffer.mask[bits];
	bits += this.endbit;
     ...
     * @return
     */
    public int readB(final int bits_in) {
	int bits = bits_in;
	int ret;
	final int m = 32 - bits;
	bits += this.endbit;
     ...
     * @return
     */
    public static int ilog(final int v_in) {
	int v = v_in;
	int ret = 0;
	while (v > 0) {
	    ret++;
